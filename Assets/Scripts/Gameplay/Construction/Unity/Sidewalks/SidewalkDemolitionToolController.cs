...
{
    /// <summary>
    /// Coordinates rectangular Sidewalk demolition through the shared
    ...
    public sealed class SidewalkDemolitionToolController :
        MonoBehaviour
    {
        [Header("Input")]
        ...
        [Header("Sidewalk Demolition Tool")]

        [SerializeField]
        private GridCellTargetResolver cellTargetResolver;

        [SerializeField]
        private SidewalkDemolitionAreaPreviewView previewView;
        ...
        [ContextMenu("Activate Sidewalk Demolition Tool")]
        public void ActivateTool()
        {
            if (!Application.isPlaying)
            {
                Debug.LogWarning(
                    "The Sidewalk demolition tool can only be " +
        ...
        [ContextMenu("Deactivate Sidewalk Demolition Tool")]
        ...
        private void BeginArea()
        {
            ...
            {
                LogWarning(
                    "Sidewalk demolition could not begin because " +
            ...
            {
                Debug.LogError(
                    "SidewalkDemolitionToolController could not access " +
                    "an initialized SidewalkConstructionService.",
                    this);
            ...
            {
                Debug.Log(
                    $"Sidewalk demolition area started at {StartCell}.",
                    this);
            }
        }
        ...
        private bool TryCommitCurrentArea()
        {
            ...
            {
                LogWarning(
                    "The current Sidewalk-demolition area has no " +
                    "valid geometry.");
            ...
            {
                Debug.LogError(
                    "The current Sidewalk-demolition area could not " +
            ...
            {
                Debug.Log(
                    $"Sidewalk demolition area processed. " +
        ...
        private void CancelCurrentArea()
        {
            ...
            {
                Debug.Log(
                    "Current Sidewalk-demolition area cancelled.",
                    this);
            }
            ...
            bool isActive)
        {
            ...
            if (logDemolitionResults)
            {
                Debug.Log(
                    IsActive
                        ? "Sidewalk demolition tool activated."
                        : "Sidewalk demolition tool deactivated.",
                    this);
            }
        }
        ...
        private bool TryResolveActions()
        {
            ...
            {
                Debug.LogError(
                    "SidewalkDemolitionToolController could not find " +
            ...
            {
                Debug.LogError(
                    $"SidewalkDemolitionToolController requires actions " +
            ...
            SidewalkClearResult result)
        {
            ...
            Debug.LogWarning(
                $"Sidewalk demolition area could not be processed. " +
        ...
        private bool ValidateReferences()
        {
            ...
            {
                Debug.LogError(
                    "SidewalkDemolitionToolController has no " +
            ...
            if (previewView == null)
            {
                Debug.LogError(
                    "SidewalkDemolitionToolController has no " +
                    "SidewalkDemolitionAreaPreviewView assigned.",
                    this);
