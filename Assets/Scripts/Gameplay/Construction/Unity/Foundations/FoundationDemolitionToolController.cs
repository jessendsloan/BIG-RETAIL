...
{
    /// <summary>
    /// Coordinates rectangular Foundation demolition through the shared
    /// construction pointer.
    ///
    /// Mouse gestures press, drag, and release. Gamepad gestures select the
    /// first corner and then confirm the opposite corner. Empty cells are
    /// skipped, and successful removals are recorded in shared history.
    /// </summary>
    [DisallowMultipleComponent]
    [DefaultExecutionOrder(150)]
    public sealed class FoundationDemolitionToolController :
        MonoBehaviour
    {
        [Header("Input")]
        ...
        [Header("Foundation Demolition Tool")]

        [SerializeField]
        private GridCellTargetResolver cellTargetResolver;

        [SerializeField]
        private FoundationDemolitionAreaPreviewView previewView;
        ...
        [ContextMenu("Activate Foundation Demolition Tool")]
        public void ActivateTool()
        {
            if (!Application.isPlaying)
            {
                Debug.LogWarning(
                    "The Foundation demolition tool can only be " +
        ...
        [ContextMenu("Deactivate Foundation Demolition Tool")]
        ...
        private void BeginArea()
        {
            ...
            {
                LogWarning(
                    "Foundation demolition could not begin because " +
                    "no grid cell is currently targeted.");

                return;
            }

            if (!foundationRuntimeHost.TryInitialize()
                || foundationRuntimeHost.FoundationConstruction == null)
            {
                Debug.LogError(
                    "FoundationDemolitionToolController could not access " +
                    "an initialized FoundationConstructionService.",
                    this);
            ...
            {
                Debug.Log(
                    $"Foundation demolition area started at {StartCell}.",
                    this);
            }
        }
        ...
        private bool TryCommitCurrentArea()
        {
            ...
            {
                LogWarning(
                    "The current Foundation-demolition area has no " +
                    "valid geometry.");
            ...
            {
                Debug.LogError(
                    "The current Foundation-demolition area could not " +
                    "be recorded because construction history is " +
                    "unavailable.",
                    this);
            ...
            {
                Debug.Log(
                    $"Foundation demolition area processed. " +
        ...
        private void CancelCurrentArea()
        {
            ...
            {
                Debug.Log(
                    "Current Foundation-demolition area cancelled.",
                    this);
            }
            ...
            bool isActive)
        {
            ...
            if (logDemolitionResults)
            {
                Debug.Log(
                    IsActive
                        ? "Foundation demolition tool activated."
                        : "Foundation demolition tool deactivated.",
                    this);
            }
        }
        ...
        private bool TryResolveActions()
        {
            ...
            {
                Debug.LogError(
                    "FoundationDemolitionToolController could not find " +
            ...
            {
                Debug.LogError(
                    $"FoundationDemolitionToolController requires actions " +
                    $"named '{confirmActionName}' and '{cancelActionName}' " +
                    $"inside the '{constructionActionMapName}' Action Map.",
                    this);
            ...
            FoundationClearResult result)
        {
            ...
            Debug.LogWarning(
                $"Foundation demolition area could not be processed. " +
        ...
        private bool ValidateReferences()
        {
            ...
            {
                Debug.LogError(
                    "FoundationDemolitionToolController has no " +
            ...
            if (previewView == null)
            {
                Debug.LogError(
                    "FoundationDemolitionToolController has no " +
                    "FoundationDemolitionAreaPreviewView assigned.",
                    this);
