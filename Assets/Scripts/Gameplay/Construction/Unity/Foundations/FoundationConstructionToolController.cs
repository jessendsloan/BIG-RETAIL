...
{
    /// <summary>
    /// Coordinates rectangular Foundation construction through the shared
        ...
        MonoBehaviour
    {
        ...
        [SerializeField]
        private FoundationAreaPreviewView previewView;
        ...
        private bool TryCommitCurrentArea()
        {
            ...
            FoundationEnsureResult result =
                foundationRuntimeHost.FoundationConstruction
                    .TryEnsureFoundations(CurrentAreaPlan.Cells);
