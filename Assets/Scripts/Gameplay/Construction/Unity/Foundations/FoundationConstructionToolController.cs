...
{
    /// <summary>
    /// Coordinates rectangular foundation construction.
    ///
    /// Mouse:
    ...
    public sealed class FoundationConstructionToolController :
        MonoBehaviour
    {
        [Header("Input")]
        ...
        [SerializeField]
        private FoundationAreaPreviewView
            previewView;

        [SerializeField]
        private FoundationRuntimeHost
        ...
        [ContextMenu("Activate Foundation Construction Tool")]
        public void ActivateTool()
        {
            if (!Application.isPlaying)
            {
                Debug.LogWarning(
                    "The foundation construction tool can only be " +
        ...
        [ContextMenu("Deactivate Foundation Construction Tool")]
        ...
        private void BeginArea()
        {
            ...
            {
                LogWarning(
                    "Foundation construction could not begin because " +
            ...
            {
                Debug.LogError(
                    "FoundationConstructionToolController could not " +
                    "access an initialized FoundationConstructionService.",
                    this);
            ...
            {
                Debug.LogError(
                    "FoundationConstructionToolController could not access " +
            ...
            {
                Debug.Log(
                    $"Foundation area started at {StartCell}.",
                    this);
            }
        }
        ...
        private bool TryCommitCurrentArea()
        {
            ...
            {
                LogWarning(
                    "The current foundation area has no valid geometry.");
            ...
            {
                Debug.LogError(
                    "The current foundation area could not be recorded " +
        ...
        private void CancelCurrentArea()
        {
            ...
            {
                Debug.Log(
                    "Current foundation area cancelled.",
                    this);
            }
            ...
            bool isActive)
        {
            ...
            if (logConstructionResults)
            {
                Debug.Log(
                    IsActive
                        ? "Foundation construction tool activated."
                        : "Foundation construction tool deactivated.",
                    this);
            }
        }
        ...
        private bool TryResolveActions()
        {
            ...
            {
                Debug.LogError(
                    "FoundationConstructionToolController could not find " +
            ...
            {
                Debug.LogError(
                    $"FoundationConstructionToolController requires " +
            ...
            FoundationEnsureResult result)
        {
            ...
            Debug.LogWarning(
                $"Foundation area could not be processed. " +
        ...
        private bool ValidateReferences()
        {
            ...
            {
                Debug.LogError(
                    "FoundationConstructionToolController has no " +
            ...
            if (previewView == null)
            {
                Debug.LogError(
                    "FoundationConstructionToolController has no " +
                    "FoundationAreaPreviewView assigned.",
                    this);
